  ...
  <TableLayout :permissions="['system:location:query']">
    ...
    <el-form ref="searchForm" slot="search-form" :model="searchForm" label-width="100px" inline>
      ...
      <el-form-item label="长途区号" prop="areaCode">
        <el-input v-model="searchForm.areaCode" placeholder="请输入长途区号" @keypress.enter.native="search"></el-input>
      </el-form-item>
    ...
    <template v-slot:table-wrap>
      ...
      >
        ...
        <el-table-column prop="areaCode" label="长途区号" min-width="100px"></el-table-column>
...
import OperaLocationWindow from '@/components/system/OperaLocationWindow'
